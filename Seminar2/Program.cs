...
//--------------------------------------------------Задача 3
//Условие: Вводится строка слов, разделенных пробелами. Найти самое длинное слово и вывести его на экран. Случай, когда самых длинных слов может быть несколько,не обрабатывать. one two three four five six seven
//Решение: 